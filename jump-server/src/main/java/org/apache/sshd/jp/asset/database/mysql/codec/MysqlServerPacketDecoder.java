...
@Slf4j
public class MysqlServerPacketDecoder extends ByteToMessageDecoder {
...
//        log.info("channelRead:{}", in);
        ...
        log.info("[Server-Decoder]channel '{}' read:{}", ctx.channel().remoteAddress(), Arrays.toString(dest));
        ...
        if (in.readableBytes() > 0) {
            // clear buffer
            log.error("[Server-Decoder]clear buffer ignore read");
